...
export const asyncRoutes = [
  {
    ...
    path: '/sys',
    component: Layout,
    meta: { title: '商品管理', icon: 'sp' },
    children: [
      {
        path: 'category',
        component: () => import('@/pages/sys/Category'),
        name: 'category',
        meta: { title: '栏目管理', icon: 'lmgl' }
      },
      {
        path: 'product',
        component: () => import('@/pages/sys/Product'),
        name: 'product',
        meta: { title: '产品管理', icon: 'cpgl' }
      },
      {
        path: 'product_details',
        hidden: true,               //不显示在左侧栏目上面
